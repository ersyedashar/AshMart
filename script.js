...
(function () {
  ...
  const products = [
    ...
    { id:12, title:'Samsung 55" OLED 4K Smart TV', category:'electronics', price:99999, originalPrice:139999, rating:4.7, reviews:2345, badge:'sale', badgeText:'-28%', image:'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=400&q=80', images:['https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=600&q=80','https://images.unsplash.com/photo-1461151304267-38535e780c79?w=600&q=80','https://images.unsplash.com/photo-1577909226027-2c84878a6068?w=600&q=80'], description:'Samsung 55-inch OLED 4K Smart TV with Neural Quantum Processor, Dolby Atmos, Smart Hub, 120Hz refresh rate, Alexa built-in.', colors:['#1a1a2e'], sizes:['55"','65"','77"'], featured:false },
    { id:13, title:"Calvin Klein Cotton Boxer Briefs", category:'fashion', price:1499, originalPrice:2499, rating:4.5, reviews:9876, badge:'popular', badgeText:'Popular', image:'https://images.unsplash.com/photo-1586363104862-3a5e2ab60d99?w=400&q=80', images:['https://images.unsplash.com/photo-1586363104862-3a5e2ab60d99?w=600&q=80','https://images.unsplash.com/photo-1586363104862-3a5e2ab60d9a?w=600&q=80','https://images.unsplash.com/photo-1586363104862-3a5e2ab60d9b?w=600&q=80'], description:"Calvin Klein Men's Cotton Stretch Boxer Briefs, logo waistband, soft breathable fabric, 3-pack.", colors:['#1a1a2e','#2d3436','#f5f5f5'], sizes:['S','M','L','XL'], featured:false },
    ...
    { id:25, title:'Samsung Galaxy Buds2 Pro', category:'electronics', price:11999, originalPrice:17999, rating:4.6, reviews:4567, badge:'sale', badgeText:'-33%', image:'https://images.unsplash.com/photo-1606220588913-b3aacb4d2f46?w=400&q=80', images:['https://images.unsplash.com/photo-1606220588913-b3aacb4d2f46?w=600&q=80','https://images.unsplash.com/photo-1606841837239-c5a1a4a07af7?w=600&q=80','https://images.unsplash.com/photo-1590658268037-6bf12f032f55?w=600&q=80'], description:'Samsung Galaxy Buds2 Pro, 24-bit Hi-Fi audio, intelligent ANC, 360 Audio, IPX7 water resistant, 5hr + 13hr with case.', colors:['#f5f5f5','#1a1a2e','#c09bd8'], sizes:['Standard'], featured:false },
    ...
    { id:27, title:'LG C3 65" OLED evo TV', category:'electronics', price:149999, originalPrice:199999, rating:4.8, reviews:2345, badge:'sale', badgeText:'-25%', image:'https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=400&q=80', images:['https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=600&q=80','https://images.unsplash.com/photo-1461151304267-38535e780c79?w=600&q=80','https://images.unsplash.com/photo-1577909226027-2c84878a6068?w=600&q=80'], description:'LG C3 65-inch OLED evo 4K Smart TV, α9 Gen6 AI Processor, Dolby Vision & Atmos, 120Hz, webOS 23, 4 HDMI 2.1 ports.', colors:['#1a1a2e'], sizes:['55"','65"','77"','83"'], featured:false },
    ...
    { id:30, title:'Samsonite Omni 2 Hardside', category:'accessories', price:8999, originalPrice:12999, rating:4.5, reviews:4567, badge:'sale', badgeText:'-30%', image:'https://images.unsplash.com/photo-1565026057447-bc90a3dceb97?w=400&q=80', images:['https://images.unsplash.com/photo-1565026057447-bc90a3dceb97?w=600&q=80','https://images.unsplash.com/photo-1581538909593-e5b1cb2f2887?w=600&q=80','https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&q=80'], description:'Samsonite Omni 2 Hardside Luggage, 24-inch, polycarbonate shell, 4-wheel spinner, TSA lock, expandable, 10-year warranty.', colors:['#1a1a2e','#2d3436','#c0392b'], sizes:['20"','24"','28"'], featured:false },
    ...
    { id:55, title:'Realme Buds Air 5', category:'electronics', price:1799, originalPrice:3499, rating:4.3, reviews:5432, badge:'sale', badgeText:'-48%', image:'https://images.unsplash.com/photo-1606220588913-b3aacb4d2f46?w=400&q=80', images:['https://images.unsplash.com/photo-1606220588913-b3aacb4d2f46?w=600&q=80','https://images.unsplash.com/photo-1590658268037-6bf12f032f55?w=600&q=80'], description:'Realme Buds Air 5, 50dB ANC, 12.4mm titanium driver, 38hr total battery, IPX5, Bluetooth 5.3, dual device connection.', colors:['#f5f5f5','#1a1a2e','#c09bd8'], sizes:['Standard'], featured:false },
    ...
    { id:58, title:'Wildcraft 32L Backpack', category:'accessories', price:1999, originalPrice:3499, rating:4.5, reviews:3456, badge:'popular', badgeText:'Popular', image:'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&q=80', images:['https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&q=80','https://images.unsplash.com/photo-1581538909593-e5b1cb2f2887?w=600&q=80'], description:'Wildcraft 32L backpack, water resistant, padded laptop compartment, ergonomic design, multiple compartments, 5-year warranty.', colors:['#1a1a2e','#2d3436','#059669'], sizes:['Standard'], featured:false },
